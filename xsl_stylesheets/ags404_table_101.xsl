...
<html>
  ...
  <title><xsl:value-of select="Hole/HoleId"/></title>
  <link rel="stylesheet" type="text/css" href="styles/ags_format.css" />
  <script type="text/javascript" src="scripts/ags_java.js"></script>
  </head>
  <body>
  <h2><xsl:value-of select="Hole/holeInformation/Proj/ProjName"/> Ground Investigation Data for Hole  
				<xsl:element name="a">
					<xsl:attribute name="href">
						http://www.google.com/maps/place/
						<xsl:value-of select="Hole/GintCoordinateLatitude"/>,
						<xsl:value-of select="Hole/GintCoordinateLongitude"/>
					</xsl:attribute>
						<xsl:value-of select="Hole/HoleId"/>
				</xsl:element>
    </h2>
...
<h3>Particle Size Distribution Analysis Data (Grat)</h3>
	<xsl:if test="count(Grag/graResults/Grat)>0">
	<table>
		<th>Location identifier ()</th>
		<th>Depth to the TOP of sample (m)</th>
		<th>Sample Reference number ()</th>
		...
		<th>Remarks on test ()</th>
		<th>Associated file reference ()</th>
	<xsl:apply-templates select="Grag/graResults/Grat" />
	</table>
	</xsl:if>	
...
<h3>Initial Consumption of Lime Tests - Data (Lstt)</h3>
	<xsl:if test="count(Lstg/lstResults/Lstt)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Depth to the TOP of sample (m)</th>
	<th>Sample Reference number ()</th>
	...
	<xsl:apply-templates select="Lstg/lstResults/Lstt" />
	</xsl:if>
...
<h3>Triaxial Tests - Total Stress - Data (Trit)</h3>
	<xsl:if test="count(triResults/Trit)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Depth to the TOP of sample (m)</th>
	<th>Sample Reference number ()</th>
	...
	<th>Remarks on test ()</th>
	<th>Associated file reference ()</th>
	<xsl:apply-templates select="triResults/Trit" />
	</table>
	</xsl:if>
...
<h3>Monitoring Reading(Mond)</h3>
	<xsl:if test="count(monResults/Mond)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Monitoring Point identifier ()</th>
	<th>Distance of monitoring point from HOLE_ID (m)</th>
	<th>Date and time of reading (dd/mm/yyyyThh:mm)</th>
	<th>Reading Type ()</th>
	...
	<th>Test method ()</th>
	<th>nstrument/method reading/detection limit ()</th>
	...
	<th>Associated file reference ()</th>
	<xsl:apply-templates select="monResults/Mond" />
	</table>
	</xsl:if>
...
<h3>Dynamic Cone Penetrometer Tests - Data </h3>
	<xsl:if test="count(dcpResults/Dcpt)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Test date (yyyy-mm-dd)</th>
	<th>Test reference ()</th>
	...
	<xsl:apply-templates  select="dcpResults/Dcpt" />
	</table>
	</xsl:if>
...
<h3>Dynamic Probe Test(Dprb) </h3>
	<xsl:if test="count(dprResults/Dprb)>0">
	<table>
	<th>Location identifier ()</th>
	...
	<th>Associated file reference ()</th>
	<xsl:apply-templates  select="dprResults/Dprb" />
	</table>
	</xsl:if>
...
<h3>Insitu Permeability Tests - Data (Iprt) </h3>
	<xsl:if test="count(iprResults/Iprt)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Depth to TOP of test zone (m)</th>
	<th>Test number ()</th>
	...
	<th>Remarks on test ()</th>
	<th>Associated file reference ()</th>
	<xsl:apply-templates  select="ipResults/Iprt" />
	</table>
	</xsl:if>
...
<h3>Soakaway Tests - Data (Isat) </h3>
	<xsl:if test="count(isaResults/Isat)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Test number ()</th>
	...
	<th>Associated file reference ()</th>
	<xsl:apply-templates  select="isaResults/Isat" />
	</table>
	</xsl:if>
...
<h3>Pressuremeter Test Data (Pmtd) </h3>
	<xsl:if test="count(pmtResults/Pmtd)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Depth of test (m)</th>
	<th>Test reference ()</th>
	...
	<th>Remarks ()</th>
	<th>Associated file reference ()</th>
	<xsl:apply-templates  select="pmtResults/Pmtd" />
	</table>
	</xsl:if>	
	
<h3>Pressuremeter Test Results, Individual Loops (Pmtl) </h3>
	<xsl:if test="count(pmtResults/Pmtl)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Depth of test (m)</th>
	<th>Test reference ()</th>
	...
	<th>Remarks ()</th>
	<th>Associated file reference ()</th>
	<xsl:apply-templates  select="pmtResults/Pmtl" />
	</table>
	</xsl:if>
...
<h3>Plate Loading Tests - Data (Pltd) </h3>
	<xsl:if test="count(pltResults/Pltd)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Test depth ()</th>
	<th>Test Reference ()</th>
	...
	<th>Associated file reference ()</th>
	<xsl:apply-templates  select="pltResults/Pltd" />
	</table>
	</xsl:if>
...
<h3>Pumping Tests - Data (Pumt) </h3>
	<xsl:if test="count(pumResults/Pumt)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Test reference ()</th>
	...
	<th>Remark ()</th>
	<th>Associated file reference ()</th>
	<xsl:apply-templates  select="pumResults/Pumt" />
	</table>
	</xsl:if>	
...
<h3>Static Cone Dissipation Tests - General (Scdt) </h3>
	<xsl:if test="count(scdResults/Scdt)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Test reference or push number ()</th>
	<th>Depth of dissipation test (m)</th>
	...
	<th>Remarks ()</th>
	<th>Associated file reference ()</th>
	<xsl:apply-templates  select="scdResults/Scdt" />
	</table>
	</xsl:if>
...
<h3>Static Cone Penetration Tests - Data (Scpt) </h3>
	<xsl:if test="count(scpResults/Scpt)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Test reference or push number ()</th>
	...
	<th>Associated file reference ()</th>
	<xsl:apply-templates  select="scpResults/Scpt" />
	</table>
	</xsl:if>

<h3>Static Cone Penetration Tests - Derived Parameters (Scpp) </h3>
	<xsl:if test="count(scpResults/Scpp)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Test reference or push number ()</th>
	...
	<th>Associated file reference ()</th>
	<xsl:apply-templates  select="scpResults/Scpp" />
	</table>
	</xsl:if>
...
<h3>Water Strike Information </h3>
	<xsl:if test="count(Wstg/wstResults/Wstk)>0">
	<table>
	<th>Location identifier ()</th>
	<th>Depth to water strike (m)</th>
	...
	<th>Remarks on test ()</th>
	<th>Associated file reference ()</th>
	<xsl:apply-templates select="Wstg/wstResults/Wstk" />
	</table>
	</xsl:if>
