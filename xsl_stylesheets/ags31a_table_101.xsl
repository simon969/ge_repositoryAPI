...
<img width="140" height="115" alt="logo" src="TTT-FLO logo.png"/>
  ...
  <table>
  <th><h2><a href="#holeInformation">holeInformation</a></h2></th>
  <th><h2><a href="#laboratoryTesting">LaboratoryTesting</a></h2></th>
  <th><h2><a href="#monitoring">monitoring</a></h2></th> 
  <th><h2><a href="#fieldTesting">fieldTesting</a></h2></th>
  <th><h2><a href="#groundInformation">GroundInformation</a></h2></th>
  </table>
  <xsl:apply-templates/> 
  </body>
  </html>
